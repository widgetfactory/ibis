 ...
 * @code https://github.com/ibis/ibis/tree/main/modules/ibis/src/core/main/ts/api/html/Sanitization.ts
 ...
 * @param {ibis.html.Schema} schema HTML schema defining valid elements and attributes.
 */

(function (ibis) {
    var each = ibis.each;
    var isDomSafe = ibis.util.URI.isDomSafe;
    var filteredUrlAttrs = ibis.makeMap('src,href,data,background,action,formaction,poster,xlink:href');

    /**
     * Constructs a new Sanitizer instance.
     * @constructor
     * @param {Object} settings - Sanitizer settings.
     * @param {ibis.html.Schema} schema - HTML schema for validation.
     */
    ibis.html.Sanitizer = function (settings, schema) {
