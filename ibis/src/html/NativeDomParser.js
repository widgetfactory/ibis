 ...
 * @code https://github.com/ibis/ibis/tree/main/modules/ibis/src/core/main/ts/api/html/DomParser.ts
 * @code https://github.com/ibis/ibis/tree/main/modules/ibis/src/core/main/ts/html/InvalidNodes.ts
 * @code https://github.com/ibis/ibis/tree/main/modules/ibis/src/core/main/ts/html/ParserFilters.ts
 *
...
(function (ibis) {
  var Node = ibis.html.Node,
    TransparentElements = ibis.html.TransparentElements,
    InvalidNodes = ibis.html.InvalidNodes,
    FilterNode = ibis.html.FilterNode,
    each = ibis.each,
    explode = ibis.explode,
    extend = ibis.extend,
    makeMap = ibis.makeMap;
   ...
   *
   * @example
   * var parser = new ibis.html.DomParser({validate: true}, schema);
   * var rootNode = parser.parse('<h1>content</h1>');
   *
   * @class ibis.html.DomParser
   */
   ...
   * @param {ibis.html.Schema} schema HTML Schema class to use when parsing.
   */
  ibis.html.DomParser = function (settings, schema) {
    var self = this,
      nodeFilters = [],
      attributeFilters = [];
    ...
    self.schema = schema = schema || new ibis.html.Schema();

    settings.sanitize_html = "sanitize_html" in settings ? settings.sanitize_html : true;

    var Sanitizer = new ibis.html.Sanitizer(settings, schema);
     ...
     * @return {ibis.html.Node} Root node containing the tree.
     */
    self.parse = function (html, args) {
       ...
       * @param {ibis.html.Node} node - The node to inspect.
       ...
       * @param {ibis.html.Node} node - The node to check.
       ...
       * @param {ibis.html.Node} node - Node to test.
       ...
       * @param {ibis.html.Node} node - Node to evaluate.
       * @param {boolean} start - True to test start edge, false for end edge.
       * @param {ibis.html.Node} root - Root context node.
       ...
       * @param {ibis.html.Node} node - The empty node to pad or replace.
       */
       ...
       * @param {ibis.html.Node} node - Node to inspect.
