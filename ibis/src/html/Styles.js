 ...
 *
 * @example
 * var Styles = new ibis.html.Styles({
 ...
 * styles.color = 'red';
 *
 * console.log(new ibis.html.StyleSerializer().serialize(styles));
 *
 * @class ibis.html.Styles
 * @version 3.4
 */
ibis.html.Styles = function (settings, schema) {
	/*jshint maxlen:255 */
	/*eslint max-len:0 */
