...
(function (ibis) {
   ...
   *
   * @example
   * var node = new ibis.html.Node('strong', 1);
   * someRoot.append(node);
   *
   * @class ibis.html.Node
   * @version 3.4
   */
  ...
  ibis.extend(Node.prototype, {
     ...
     *
     * @method replace
     * @param {ibis.html.Node} node Node to replace the current node with.
     * @return {ibis.html.Node} The old node that got replaced.
     */
     ...
     * @return {String/ibis.html.Node} String or undefined on a get operation or the current node on a set operation.
     */
    ...
    addClass: function (str) {
      ...
      if (str.indexOf(' ') !== -1) {
        ...
        ibis.each(str.split(' '), function (val) {
          self.addClass(val);
        });
     ...
     *
     * @method clone
     * @return {ibis.html.Node} New copy of the original node.
     */
    clone: function (deep) {
      var self = this,
     ...
     *
     * @method remove
     * @return {ibis.html.Node} Current node that got removed.
     */
    remove: function () {
      var self = this,
        parent = self.parent,
     ...
     *
     * @method append
     * @param {ibis.html.Node} node Node to append as a child of the current one.
     * @return {ibis.html.Node} The node that got appended.
     */
     ...
     *
     * @method insert
     * @param {ibis.html.Node} node Node to insert as a child of the current node.
     * @param {ibis.html.Node} ref_node Reference node to set node before/after.
     * @param {Boolean} before Optional state to insert the node before the reference node.
     * @return {ibis.html.Node} The node that got inserted.
     */
     ...
     *
     * @method empty
     * @return {ibis.html.Node} The current node that got cleared.
     */
    empty: function () {
      var self = this,
        nodes, i, node;
     ...
     * @return {ibis.html.Node} Node that is next to or previous of the current node.
     */
    walk: function (prev) {
