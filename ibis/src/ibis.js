...
(function (win) {
  ...
  var ibis = {
    ...
    _init: function () {
      ...
      function getBase(n) {
        if (n.src && /ibis(|_gzip|_jquery|_prototype|_full)(_dev|_src)?.js/.test(n.src)) {
     ...
     *
     * // Iterate an object
     * ibis.each({a : 1, b : 2, c: 3], function(v, k) {
     ...
     * var items = ibis.grep([1,2,3,4,5], function(v) {return v > 3;});
     */
    grep: function (a, f) {
      var o = [];
     ...
     * var obj = ibis.extend(obj1, {
     *     somefield1 : 'a',
     *     somefield2 : 'a'
     * });
     *
     * // Extends obj with obj2 and obj3
     * ibis.extend(obj, obj2, obj3);
     */
     ...
     * ibis.create('ibis.somepackage.SomeClass', {
     *     SomeClass : function() {
     *         // Class constructor
     *     },
     *
     ...
     * ibis.create('ibis.somepackage.SomeSubClass:ibis.somepackage.SomeClass', {
     ...
     * ibis.create('static ibis.somepackage.SomeSingletonClass', {
     *     method : function() {
     *         // Some method
     *     }
     * });
     ...
     * ibis.createNS('ibis.somepackage.subpackage');
     *
     * // Add a singleton
     * var ibis.somepackage.subpackage.SomeSingleton = {
     *     method : function() {
     *         // Some method
     *     }
     * };
    ...
    explode: function (s, d) {
      ...
      return ibis.map(s.split(d || ','), ibis.trim);
    },
    ...
    curry: function (fn) {
      ...
      return function () {
        ...
        return ibis.curry.apply(this, tempArgs);
      };
    },
  ...
  // Expose ibis namespace to the global namespace (window)
  win.ibis = win.tinymce = win.tinyMCE = ibis;
