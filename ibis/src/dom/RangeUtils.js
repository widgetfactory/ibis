...
(function (ibis) {
	...
	ibis.dom.RangeUtils = function (dom) {
		/**
	 ...
	 */
	ibis.dom.RangeUtils.compareRanges = function (rng1, rng2) {
		if (rng1 && rng2) {
	...
	function findClosestIeRange(clientX, clientY, doc) {
		...
		rects = Arr.toArray(rng.getClientRects());
	 ...
	 */
	ibis.dom.RangeUtils.getCaretRangeFromPoint = function (clientX, clientY, doc) {
		var rng, point;
	...
	ibis.dom.RangeUtils.getSelectedNode = function (range) {
	...
	ibis.dom.RangeUtils.getNode = function (container, offset) {
