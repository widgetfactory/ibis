 ...
 *
 * @class ibis.dom.BookmarkManager
 */
(function (ibis) {
  var NodeType = ibis.dom.NodeType,
    CaretBookmark = ibis.caret.CaretBookmark,
    CaretContainer = ibis.caret.CaretContainer,
   ...
   * @param {ibis.dom.Selection} selection Selection instance to handle bookmarks for.
   */
  function BookmarkManager(selection) {
    ...
    this.getBookmark = function (type, normalized) {
      ...
      function findIndex(name, element) {
        ...
        ibis.each(dom.select(name), function (node) {
      ...
      function restoreEndPoint(suffix) {
        ...
        if (marker) {
          ...
          if (!keep) {
            ...
            ibis.each(ibis.grep(marker.childNodes), function (node) {
              if (node.nodeType == 3) {
  ...
  ibis.dom.BookmarkManager = BookmarkManager;
