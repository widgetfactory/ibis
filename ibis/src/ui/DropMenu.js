...
(function (ibis) {
   ...
   *
   * @class ibis.ui.DropMenu
   * @extends ibis.ui.Menu
   * @example
   * // Adds a menu to the currently active editor instance
   * var dm = ibis.activeEditor.controlManager.createDropMenu('somemenu');
   *
   * // Add some menu items
   ...
   * dm.showMenu(100, 100);
   */
  ibis.create('ibis.ui.DropMenu:ibis.ui.Menu', {
    /**
    ...
    DropMenu: function (id, s) {
      ...
      this._super(id, s);
      this.onShowMenu = new ibis.util.Dispatcher(this);
      this.onHideMenu = new ibis.util.Dispatcher(this);
      this.onFilterInput = new ibis.util.Dispatcher(this);
     ...
     * @method createMenu
     * @param {Object} s Optional name/value settings object.
     * @return {ibis.ui.DropMenu} New drop menu instance.
     */
    createMenu: function (s) {
      ...
      m = new ibis.ui.DropMenu(s.id || DOM.uniqueId(), s);
    ...
    selectItem: function (item, state) {
      ...
      if (state) {
        ...
        var idx = ibis.inArray(self.selected, item);
    ...
    showMenu: function (x, y, px, py) {
      ...
      each(self.items, function (o) {
        if (o.selected) {
          if (ibis.inArray(self.selected, o) === -1) {
     ...
     *
     * @method add
     * @param {ibis.ui.Control} o Menu or menu item to add to the drop menu.
     * @return {ibis.ui.Control} Same as the input control, the menu or menu item.
     */
    add: function (o) {
      var self = this,
        co;
     ...
     *
     * @method remove
     * @param {ibis.ui.Control} o Menu item or menu to remove from drop menu.
     * @return {ibis.ui.Control} Control instance or null if it wasn't found.
     */
    remove: function (o) {
      DOM.remove(o.id);
      this.destroy();
    ...
    _setupKeyboardNav: function () {
      ...
      self.keyboardNav = new ibis.ui.KeyboardNavigation({
        root: 'menu_' + self.id,
        items: menuItems,
        onCancel: function () {
          self.hideMenu();
