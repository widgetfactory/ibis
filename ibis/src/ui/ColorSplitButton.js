...
(function (ibis) {
  ...
  /**
	 ...
	 *
	 * @class ibis.ui.ColorSplitButton
	 * @extends ibis.ui.SplitButton
	 */
  ibis.create('ibis.ui.ColorSplitButton:ibis.ui.SplitButton', {
    /**
    ...
    showMenu: function () {
      ...
      this.keyboardNav = new ibis.ui.KeyboardNavigation({
        root: this.id + '_menu',
