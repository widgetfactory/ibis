...
function convertURLs(editor, content) {
    ...
    function createLink(url) {
        ...
        attribs = ibis.extend(attribs, params.attributes || {});
...
function insertClipboardContent(editor, clipboardContent, internal, pasteAsPlainText) {
    ...
    // get html content
    content = clipboardContent['x-ibis/html'] || clipboardContent['text/html'];
...
ibis.clipboard.FakeClipboard = FakeClipboard;
