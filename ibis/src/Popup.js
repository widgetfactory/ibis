...
var ibisPopup = {
	...
	init: function () {
		 ...
		 * ibisPopup.onInit.add(function(ed) {
		 *     alert(ed.selection.getContent());
		 * });
		 *
		 * // Executes the init method on page load in some object using the SomeObject scope
		 * ibisPopup.onInit.add(SomeObject.init, SomeObject);
		 */
		this.onInit = {
	...
	close: function () {
		if (this.editor) {
			...
			ibis = ibis = this.editor = this.params = this.dom = this.dom.doc = null; // Cleanup
		}
	},
	...
	_onDOMLoaded: function () {
		...
		ibis.each(this.listeners, function (o) {
