...
(function (ibis) {
  ...
  /**
	 ...
	 *
	 * @class ibis.UndoManager
	 */
  ibis.UndoManager = function (editor) {
    var um, index = 0,
      data = [],
    ...
    function getContent() {
      ...
      return ibis.trim(editor.getContent({
        format: 'raw',
        no_events: 1,
        undo: true
      }));
    ...
    um = {
      ...
      /**
			 ...
			 *
			 * @event onBeforeAdd
			 * @param {ibis.um} sender um instance that is going to add the new level
      ...
      /**
			 ...
			 *
			 * @event onAdd
			 * @param {ibis.um} sender um instance that got the new level.
			 * @param {Object} level The new level object containing a bookmark and contents.
			 */
      onAdd: onAdd,
