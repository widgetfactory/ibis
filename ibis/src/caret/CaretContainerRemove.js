...
(function (ibis) {
  var NodeType = ibis.dom.NodeType, Zwsp = ibis.text.Zwsp, CaretContainer = ibis.caret.CaretContainer, CaretPosition = ibis.caret.CaretPosition;
  var Arr = ibis.util.Arr;
  ...
  ibis.caret.CaretContainerRemove = {
