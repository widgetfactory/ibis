...
(function (ibis) {
  var NodeType = ibis.dom.NodeType,
    ...
    CaretUtils = ibis.caret.CaretUtils,
  ...
  ibis.caret.CaretWalker = function (rootNode) {
    return {
      /**
       ...
       *
       * @method next
       * @param {ibis.caret.CaretPosition} caretPosition Caret position to start from.
       * @return {ibis.caret.CaretPosition} CaretPosition or null if no position was found.
       */
