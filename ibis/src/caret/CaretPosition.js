 ...
 *
 * @private
 * @class ibis.caret.CaretPosition
 * @example
...
(function (ibis) {
  var NodeType = ibis.dom.NodeType,
    DOMUtils = ibis.DOM,
    CaretCandidate = ibis.caret.CaretCandidate,
    RangeUtils = ibis.dom.RangeUtils,
    ClientRect = ibis.geom.ClientRect,
    ExtendingChar = ibis.text.ExtendingChar,
    Fun = ibis.util.Fun;
  ...
  function CaretPosition(container, offset, clientRects) {
    ...
    return {
       ...
       *
       * @method isEqual
       * @param {ibis.caret.CaretPosition} caretPosition Caret position to compare with.
   ...
   * @return {ibis.caret.CaretPosition} Caret position from the start of DOM range.
   */
   ...
   * @method fromRangeEnd
   * @param {DOMRange} range DOM Range to create caret position from.
   * @return {ibis.caret.CaretPosition} Caret position from the end of DOM range.
   */
   ...
   * @return {ibis.caret.CaretPosition} Caret position from the node.
   */
  ...
  ibis.caret.CaretPosition = CaretPosition;
